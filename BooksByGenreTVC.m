...
-(void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender{
    ...
    if ([segue.identifier isEqualToString:@"toDetails"]) {
        ...
        self.currentBook=[self.fetchedResultsController objectAtIndexPath:indexPath];
        BookDetailTVC *bdtvc=(BookDetailTVC *)[segue destinationViewController];
        bdtvc.currentBook=self.currentBook;
        bdtvc.managedObjectContext=self.managedObjectContext;
    }
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    // Configure the cell...
   self.currentBook=[self.fetchedResultsController objectAtIndexPath:indexPath];
    cell.textLabel.text=self.currentBook.title;
    if (self.currentBook.favorite.favorite==nil) {
        cell.detailTextLabel.text=[NSString stringWithFormat:@"by %@", self.currentBook.author];
    } else{
        cell.detailTextLabel.text=[NSString stringWithFormat:@"by %@ : %@", self.currentBook.author, self.currentBook.favorite.favorite];
    }
    return cell;
}
